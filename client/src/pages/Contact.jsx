      ...
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white">
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          ...
          <div>
            ...
            <Card
              title="Address"
              content="Jobhub, Sahloul, Sousse, 4500, Tunisia"
            />
            <Card
              title="Email"
              content={[
                "General Inquiries: info@jobhub.com",
                "Support: support@jobhub.com",
                "Job Applications: jobs@jobhub.com",
              ]}
            />
            <Card
              title="Phone"
              content={[
                "Customer Support: +216 95632147",
                "HR & Job Inquiries: +216 98520140",
              ]}
            />
