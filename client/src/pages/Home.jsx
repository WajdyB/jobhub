...
export const Home = () => {
    ...
    const data = [
        {
            link: "/images/companies/eDonec.jpg"
        },
        {
            link: "/images/companies/proxym.jpg"
        },
        {
            link: "/images/companies/Sofricom.png"
        },
        {
            link: "/images/companies/vermeg.png"
        }
    ]
            ...
            <div className='min-h-screen md:px-20 px-3  pt-14 flex   text-white bg-gray-950'>
                <div className='  w-full  flex  pt-28 flex-col justify-start  items-center gap-4'>
                    ...
                    <div className='flex md:flex-row flex-col items-center justify-center md:gap-10 gap-1'>
                        <div className='md:text-8xl text-6xl titleT'>JOBHUB</div>
                        <div className=' flex justify-center items-center pt-1'>
                            <Link to="/jobs" className='font-semibold md:text-2xl text-lg blueCol  md:py-3 py-2 px-6 md:px-10 '>Browse Jobs</Link>
                        </div>
                    </div>
                    <div>
                        <p className='md:text-xl text-sm'>If you're searching for <span className='text-yellow-500'> JOBS  </span> This is the place for you !</p>
                    ...
                    <div className="pt-[7rem] pb-[10rem] md:px-[14rem] px-[1rem]   text-center">
                        <p>Discover the Power of Possibility with JOBHUB : Where Your Professional Journey Takes Flight, Guided by a Network of Diverse Opportunities!</p>
                    </div>
